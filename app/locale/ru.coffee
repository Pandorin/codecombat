...
#    story_statistic_2a: "We’ve been translated into over 50 languages — our players hail from"
    ...
    story_statistic_3a: "Вместе они написали"
    story_statistic_3b: "1 миллиард строк кода и вычислений"
...
#    jobs_custom_contact_2: "introducing yourself and we might get in touch in the future!"
    ...
    contact_subtitle: "Нужно больше информации? Свяжитесь с нами"
    screenshots_title: "Скриншоты Игры"
    screenshots_hint: "(нажмите, чтобы посмотреть полный размер)"
